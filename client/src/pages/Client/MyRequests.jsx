...
export default function MyRequests() {
  ...
  // NEW: State to toggle the document viewer inside the modal
  ...
  useEffect(() => {
    if (!isLoading && requests.length > 0 && location.state?.highlightReqId) {
      ...
      if (targetReq) {
        ...
        setViewingDocument(false); // Reset viewer state
      }
  ...
  return (
    <>
      <style>{`
        /* UPDATED: Properly padded custom scrollbar */
          ...
          <div className="flex-1 pb-10 flex flex-col h-[calc(100vh-100px)]">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8 flex-shrink-0">
              ...
              <div className="relative w-full sm:w-64" ref={filterRef}>
                ...
                {isFilterOpen && (
                  <div className="absolute top-full right-0 mt-2 w-full bg-white border border-gray-100 rounded-xl shadow-xl z-20 py-1 max-h-64 overflow-y-auto animate-in fade-in slide-in-from-top-2 duration-200 custom-scrollbar">
            ...
            <div className="bg-white rounded-3xl md:rounded-[2rem] border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] flex flex-col flex-1 min-h-0 overflow-hidden">
              <div className="overflow-y-auto flex-1 w-full custom-scrollbar pr-1">
                          ...
                          <td className="py-5 px-8 text-right">
                            <button 
                              onClick={() => {
                                ...
                                setViewingDocument(false); // Reset view state when opening a new one
                              }} 
        ...
        {selectedRequest && (
          <div className="fixed inset-0 bg-navy/60 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
            <div className="bg-white w-full max-w-3xl rounded-3xl shadow-2xl flex flex-col max-h-[85vh] animate-in fade-in zoom-in-95 duration-200">
              ...
              <div className="p-6 md:p-8 overflow-y-auto bg-[#FAFAFA] rounded-b-3xl custom-scrollbar pr-4">
                    ...
                    <div className="flex-1 border border-gray-200 rounded-2xl overflow-hidden bg-white shadow-sm flex items-center justify-center relative">
                      {(selectedRequest.fileUrl || selectedRequest.fileData)?.startsWith('data:image') || (selectedRequest.fileUrl?.match(/\.(jpeg|jpg|gif|png)$/) != null) ? (
                        ...
                        <>
                          ...
                          />
                          {/* Fallback text shown behind the iframe in case the browser blocks it and forces a download instead */}
