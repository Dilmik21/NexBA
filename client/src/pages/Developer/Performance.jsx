    ...
    <>
      ...
      <div className="h-screen bg-[#F5F7FA] overflow-hidden flex flex-col">
        ...
        <div className="flex max-w-[1600px] w-full mx-auto pt-6 px-4 md:px-6 gap-8 pb-6 flex-1 min-h-0">
          ...
          <div className="flex-1 flex flex-col min-w-0 h-full overflow-y-auto custom-scrollbar pr-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 pb-10">
              ...
              <div className="bg-white rounded-[24px] p-7 md:p-8 border border-gray-100 shadow-sm flex flex-col h-full max-h-[500px]">
                <div className="mb-6 flex-shrink-0">
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar pr-3 space-y-3">
                  {recentCompletions.length === 0 ? (
                    ...
                    recentCompletions.map((task) => (
                      <div key={task.id} className="flex items-center justify-between p-4 rounded-[14px] border border-gray-100 hover:border-blue-100 hover:shadow-sm transition-all group bg-white">
